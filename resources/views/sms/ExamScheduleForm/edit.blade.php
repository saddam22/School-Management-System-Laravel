...
<a href="{{ route('ExamScheduleForm.index') }}" class="btn btn-primary waves-effect">All Classes</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('ExamScheduleForm.update',$ExamScheduleForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="exam_name" name="exam_name" value="{{ $ExamScheduleForm->exam_name }}" class="form-control" placeholder="Subject Name">
    </div>
</div>        
</div>     
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="time" name="time" value="{{ $ExamScheduleForm->time }}" class="form-control" placeholder="Time">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="date" name="date" value="{{ $ExamScheduleForm->date }}" class="form-control" placeholder="Date">
</div>
</div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="examschedule_form">  
    </div>
<div class="col-md-6">      
...
<script type="text/javascript">
    document.forms['editForm'].elements['subject_type'].value='{{ $ExamScheduleForm->subject_type }}';
    document.forms['editForm'].elements['class'].value='{{ $ExamScheduleForm->class}}';
    document.forms['editForm'].elements['section'].value='{{ $ExamScheduleForm->section}}';
</script>
</div>
</div>
</div>
