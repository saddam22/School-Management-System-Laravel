...
<div class="body">
 <form action="{{ route('ExamScheduleForm.store') }}" method="POST"> 
    @csrf
<div class="row clearfix">  
<div class="col-md-6">
<b>Exam Name</b>
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="exam_name" name="exam_name" class="form-control" placeholder="Subject Name">
    </div>
</div>        
</div>     
<div class="col-md-6">
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Add New" class="btn btn-primary btn-block waves-effect" name="classroutine_form">  
    </div>
<div class="col-md-6">      
