...
<div class="header">
<h2>
Add New Library - Book Information
</h2>
...
<a href="{{ route('LibraryForm.index') }}" class="btn btn-primary waves-effect">All Books</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('LibraryForm.update',$LibraryForm->id) }}" name="editForm" method="POST">	
		@csrf
	@method('put')
<div class="row clearfix">	
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="book_name" name="book_name" value="{{ $LibraryForm->book_name }}" class="form-control" placeholder="Book Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="subject" name="subject" value="{{ $LibraryForm->subject }}" class="form-control" placeholder="Subject">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="writter_name" name="writter_name" value="{{ $LibraryForm->writter_name }}" class="form-control" placeholder="Writter Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="idno" name="idno" value="{{ $LibraryForm->idno }}" class="form-control" placeholder="ID NO">
</div>
</div>
</div>
<div class="col-md-6">
<b>Book Publish Date</b>
<div class="input-group">
<div class="form-line">
    <input type="text" id="publishing_date" name="publishing_date" value="{{ $LibraryForm->publishing_date }}" class="form-control" placeholder="Book Publish Date">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="upload_date" name="upload_date" value="{{ $LibraryForm->upload_date }}" class="form-control" placeholder="Upload Date">
</div>
...
<script type="text/javascript">
	document.forms['editForm'].elements['class'].value='{{ $LibraryForm->class}}';
</script>
</div>
</div>
</div>
