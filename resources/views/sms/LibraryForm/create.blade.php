...
<div class="body">
 <form action="{{ route('LibraryForm.store') }}" method="POST" enctype="multipart/form-data">	
 	@csrf
<div class="row clearfix">	
<div class="col-md-6">
<b>Book Name</b>
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="writter_name" name="writter_name" class="form-control" placeholder="Writter Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="publishing_date" name="publishing_date" class="form-control" placeholder="Book Publish Date">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="upload_date" name="upload_date" class="form-control" placeholder="Upload Date">
</div>
