...
<div class="body">
 <form action="{{ route('AccountForm.store') }}" method="POST" enctype="multipart/form-data"> 
    @csrf
<div class="row clearfix">  
<div class="col-md-6">
<b>First Name</b>
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="faname" name="faname" class="form-control">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="moname" name="moname" class="form-control">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="joining" name="joining" class="form-control">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Add New" class="btn btn-primary btn-block waves-effect" name="account_form">  
    </div>
<div class="col-md-6">      
