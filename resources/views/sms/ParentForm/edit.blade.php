...
<a href="{{ route('ParentForm.index') }}" class="btn btn-primary waves-effect">All Parents</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('ParentForm.update',$ParentForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data">	
 	@csrf
 		@method('put')
<div class="row clearfix">	
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="fname" name="fname" value="{{ $ParentForm->fname }}" class="form-control" placeholder="First Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="lname" name="lname" value="{{ $ParentForm->lname }}" class="form-control" placeholder="Last Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="occupation" name="occupation" value="{{ $ParentForm->occupation }}" class="form-control" placeholder="Occupation">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="idno" name="idno" value="{{ $ParentForm->idno }}" class="form-control" placeholder="ID NO">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="email" id="email" name="email" value="{{ $ParentForm->email }}" class="form-control" placeholder="Email">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
   <textarea rows="5" cols="30" name="address" id="address" class="form-control is-valid" placeholder="Address">{{ $ParentForm->address }}</textarea>
</div>
</div>
</div>
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="phone" name="phone" value="{{ $ParentForm->phone }}" class="form-control" placeholder="Phone">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
   <textarea rows="5" cols="30" name="bio" id="bio" class="form-control is-valid" placeholder="Biography">{{ $ParentForm->bio }}</textarea>
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="row clearfix">
	<div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="parent_form">	
	</div>
<div class="col-md-6">      
...
<script type="text/javascript">
	document.forms['editForm'].elements['gender'].value='{{ $ParentForm->gender }}';
	document.forms['editForm'].elements['blood'].value='{{ $ParentForm->blood}}';
	document.forms['editForm'].elements['religion'].value='{{ $ParentForm->religion}}';
</script>
</div>
</div>
</div>
