...
<a href="{{ route('ExamForm.index') }}" class="btn btn-primary waves-effect">All Exam Grade Point</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('ExamForm.update',$ExamForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="grade_name" name="grade_name" value="{{ $ExamForm->grade_name }}" class="form-control" placeholder="Grade Name">
    </div>
</div>        
</div>         
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="percentage_form" name="percentage_form" value="{{ $ExamForm->percentage_form }}" class="form-control" placeholder="Percentage From">
    </div>
</div>        
</div>    
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="percentage_upto" name="percentage_upto" value="{{ $ExamForm->percentage_upto }}" class="form-control" placeholder="Percentage Upto">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="form-line">
   <textarea rows="5" cols="30" name="comments" id="comments" class="form-control is-valid" placeholder="Comment">{{ $ExamForm->comments }}</textarea>
</div>
</div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="exam_form">  
    </div>
<div class="col-md-6">      
...
document.forms['editForm'].elements['grade_point'].value='{{ $ExamForm->grade_point }}';
</script>
</div>
</div>
</div>
