...
<div class="body">
 <form action="{{ route('AdmissionForm.store') }}" method="POST" enctype="multipart/form-data">	
 	@csrf
<div class="row clearfix">	
<div class="col-md-6">
<b>First Name</b>
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="admission_id" name="admission_id" class="form-control" placeholder="Admissiion ID">
</div>
</div>
</div>
<div class="col-md-6">
