...
<a href="{{ route('AdmissionForm.index') }}" class="btn btn-primary waves-effect">All Students</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('AdmissionForm.update',$AdmissionForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data">	
 	@csrf
 		@method('put')
<div class="row clearfix">	
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="fname" name="fname" value="{{ $AdmissionForm->fname }}" class="form-control" placeholder="First Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="lname" name="lname" value="{{ $AdmissionForm->lname }}" class="form-control" placeholder="Last Name">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="dob" name="dob" value="{{ $AdmissionForm->dob }}" class="form-control">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="roll" name="roll" value="{{ $AdmissionForm->roll }}" class="form-control" placeholder="Roll">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="email" id="email" name="email" value="{{ $AdmissionForm->email }}" class="form-control" placeholder="Email">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="admission_id" name="admission_id" value="{{ $AdmissionForm->admission_id }}" class="form-control" placeholder="Admissiion ID">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="phone" name="phone" value="{{ $AdmissionForm->phone }}" class="form-control" placeholder="Phone">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
   <textarea rows="5" cols="30" name="bio" id="bio" class="form-control is-valid" placeholder="Biography">{{ $AdmissionForm->bio }}</textarea>
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="row clearfix">
	<div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="admission_form">	
	</div>
<div class="col-md-6">      
...
<script type="text/javascript">
	document.forms['editForm'].elements['gender'].value='{{ $AdmissionForm->gender }}';
	document.forms['editForm'].elements['blood'].value='{{ $AdmissionForm->blood}}';
	document.forms['editForm'].elements['religion'].value='{{ $AdmissionForm->religion}}';
	document.forms['editForm'].elements['class'].value='{{ $AdmissionForm->class}}';
	document.forms['editForm'].elements['section'].value='{{ $AdmissionForm->section}}';
</script>
</div>
</div>
</div>
