...
<div class="body">
 <form action="{{ route('TransportForm.store') }}" method="POST"> 
    @csrf
<div class="row clearfix">  
<div class="col-md-6">
<b>Route Name</b>
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="vehicle_number" name="vehicle_number" class="form-control" placeholder="Vehicle Number">
    </div>
</div>        
</div>    
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="driver_name" name="driver_name" class="form-control" placeholder="Driver Number">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="form-line">
    <input type="text" id="license_number" name="license_number" class="form-control" placeholder="License Number">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Add New" class="btn btn-primary btn-block waves-effect" name="transport_form">  
    </div>
<div class="col-md-6">      
