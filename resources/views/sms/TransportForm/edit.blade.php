...
<a href="{{ route('TransportForm.index') }}" class="btn btn-primary waves-effect">All Transport</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('TransportForm.update',$TransportForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="route_name" name="route_name" value="{{ $TransportForm->route_name }}" class="form-control" placeholder="Route Name">
    </div>
</div>        
</div>                
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="vehicle_number" name="vehicle_number" value="{{ $TransportForm->vehicle_number }}" class="form-control" placeholder="Vehicle Number">
    </div>
</div>        
</div>    
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="driver_name" name="driver_name" value="{{ $TransportForm->driver_name }}" class="form-control" placeholder="Driver Number">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="form-line">
    <input type="text" id="license_number" name="license_number" value="{{ $TransportForm->license_number }}" class="form-control" placeholder="License Number">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
   <input type="text" id="phone" name="phone" class="form-control" value="{{ $TransportForm->phone }}" placeholder="Phone">
</div>
</div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="transport_form">  
    </div>
<div class="col-md-6">      
