...
<a href="{{ route('ClassForm.index') }}" class="btn btn-primary waves-effect">All Classes</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('ClassForm.update',$ClassForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="teacher_name" name="teacher_name" value="{{ $ClassForm->teacher_name }}" class="form-control" placeholder="Teacher Name">
    </div>
</div>        
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="idno" name="idno" value="{{ $ClassForm->idno }}" class="form-control" placeholder="ID NO">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
    <div class="form-line">
        <input type="text" id="time" name="time" value="{{ $ClassForm->time }}" class="form-control" placeholder="Time">
    </div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="date" id="date" name="date" value="{{ $ClassForm->date }}" class="form-control" placeholder="Date">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="text" id="phone" name="phone" value="{{ $ClassForm->phone }}" class="form-control" placeholder="Phone">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="input-group">
<div class="form-line">
    <input type="email" id="email" name="email" value="{{ $ClassForm->email }}" class="form-control" placeholder="E-Mail ">
</div>
</div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="class_form">  
    </div>
<div class="col-md-6">      
...
<script type="text/javascript">
    document.forms['editForm'].elements['gender'].value='{{ $ClassForm->gender }}';
    document.forms['editForm'].elements['class'].value='{{ $ClassForm->class}}';
    document.forms['editForm'].elements['subject'].value='{{ $ClassForm->subject}}';
    document.forms['editForm'].elements['section'].value='{{ $ClassForm->section}}';
</script>
</div>
</div>
</div>
