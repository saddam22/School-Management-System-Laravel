...
<a href="{{ route('NoticeForm.index') }}" class="btn btn-primary waves-effect">All Notice</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('NoticeForm.update',$NoticeForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="title" name="title" value="{{ $NoticeForm->title }}" class="form-control" placeholder="Title">
    </div>
</div>        
</div>                       
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
         <textarea rows="5" cols="30" name="details" id="details" class="form-control is-valid" placeholder="Details">{{ $NoticeForm->details }}</textarea>
    </div>
</div>        
</div>    
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="posted" name="posted" value="{{ $NoticeForm->posted }}" class="form-control" placeholder="Posted By">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="form-line">
    <input type="date" id="date" name="date" value="{{ $NoticeForm->date }}" class="form-control" placeholder="Date">
</div>
</div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="notice_form">  
    </div>
<div class="col-md-6">      
