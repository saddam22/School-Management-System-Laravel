...
<div class="body">
 <form action="{{ route('NoticeForm.store') }}" method="POST"> 
    @csrf
<div class="row clearfix">  
<div class="col-md-6">
<b>Title</b>
...
<div class="input-group form-float">
    <div class="form-line">
         <textarea rows="5" cols="30" name="details" id="details" class="form-control is-valid" placeholder="Details"></textarea>
    </div>
</div>        
</div>    
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="posted" name="posted" class="form-control" placeholder="Posted By">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Add New" class="btn btn-primary btn-block waves-effect" name="notice_form">  
    </div>
<div class="col-md-6">      
