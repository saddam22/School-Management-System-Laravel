...
<a href="{{ route('ClassRoutineForm.index') }}" class="btn btn-primary waves-effect">All Subject</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('ClassRoutineForm.update',$ClassRoutineForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="subject_name" name="subject_name" value="{{ $ClassRoutineForm->subject_name }}" class="form-control" placeholder="Subject Name">
    </div>
</div>        
</div>         
<div class="col-md-6">
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="classroutine_form">  
    </div>
<div class="col-md-6">      
...
<script type="text/javascript">
    document.forms['editForm'].elements['subject_type'].value='{{ $ClassRoutineForm->subject_type }}';
    document.forms['editForm'].elements['class'].value='{{ $ClassRoutineForm->class}}';
    document.forms['editForm'].elements['code'].value='{{ $ClassRoutineForm->code}}';
</script>
</div>
</div>
</div>
