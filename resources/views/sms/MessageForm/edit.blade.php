...
<a href="{{ route('MessageForm.index') }}" class="btn btn-primary waves-effect">All Message</a><br>
@include('sms.partial.msg')

<div class="body">
 <form action="{{ route('MessageForm.update',$MessageForm->id) }}" method="POST" name="editForm" enctype="multipart/form-data"> 
    @csrf
        @method('put')
<div class="row clearfix">  
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="title" name="title" value="{{ $MessageForm->title }}" class="form-control" placeholder="Title">
    </div>
</div>        
</div>                               
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
        <input type="text" id="recipient" name="recipient" value="{{ $MessageForm->recipient }}" class="form-control" placeholder="Recipient">
    </div>
</div>        
</div> 
<div class="col-md-6">
...
<div class="input-group form-float">
    <div class="form-line">
         <textarea rows="5" cols="30" name="message" id="message" class="form-control is-valid" placeholder="Message">{{ $MessageForm->message }}</textarea>
    </div>
</div>        
</div> 
...
<div class="row clearfix">
    <div class="col-md-6">
<input type="submit" value="Update" class="btn btn-primary btn-block waves-effect" name="message_form">  
    </div>
<div class="col-md-6">      
