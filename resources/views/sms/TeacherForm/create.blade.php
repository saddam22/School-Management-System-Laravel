...
<div class="body">
 <form action="{{ route('TeacherForm.store') }}" method="POST" enctype="multipart/form-data">	
 	@csrf
<div class="row clearfix">	
<div class="col-md-6">
<b>First Name</b>
...
<div class="row clearfix">
	<div class="col-md-6">
<input type="submit" value="Add New" class="btn btn-primary btn-block waves-effect" name="teacher_form">	
	</div>
<div class="col-md-6">      
